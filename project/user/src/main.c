...
* 
* RT1064DVL6A ????? ?????????
* ?????????????????????????? GPL??GNU General Public License???? GNU??ï¿½ï¿½????????????????
* ?? GPL ???3?ï¿½ï¿½?? GPL3.0????????????ï¿½Ê¦ï¿½?????ï¿½ï¿½?????ï¿½ï¿½?????/???????
* 
* ????????????????????????????????ï¿½ï¿½???????ï¿½Ê¦ï¿½???
* ?????????????????????????????????
* ?????????ï¿½ï¿½? GPL
* 
* ?????????????????????????? GPL ?????
* ?????ï¿½ï¿½??????<https://www.gnu.org/licenses/>
* 
* ?????????
* ?????????? GPL3.0 ????????ï¿½ï¿½?? ?????????????????ï¿½ï¿½
...
// ?????????????????????
#define PIT_CH_Enco (PIT_CH1)    // ???????????ï¿½ï¿½?
#define PIT_PRIORITY (PIT_IRQn) // ????????ï¿½ï¿½???ï¿½ï¿½???
...
// {
//     uart1_rx_interrupt_handler();//?????ï¿½ï¿½????
//     get_uartdata();//???????????
// }
